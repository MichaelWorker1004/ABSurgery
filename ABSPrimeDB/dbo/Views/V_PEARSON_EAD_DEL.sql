CREATE VIEW dbo.V_PEARSON_EAD_DEL
AS
SELECT     'D' AS AuthorizationTransactionType, '' AS AuthorizationID,'ABS'+candidate+exam+type+cast(year as varchar)+cast(isnull(attempt,0) as varchar) AS ClientAuthorizationID, 'ABS0' + candidate AS ClientCandidateID, '1' AS ExamAuthorizationCount, 
