        ...
        public async Task InsertAsync_ExecutesSprocCorrectly()
        {
            ...
            var p =
                new
                {
                    ...
                    CertificationStatusId = expectedDto.CertificationStatusId,
                    NPI = expectedDto.NPI,
                    Gender = expectedDto.Gender,
                    BirthDate = expectedDto.BirthDate,
                    Race = expectedDto.Race,
                    Ethnicity = expectedDto.Ethnicity,
                    FirstLanguage = expectedDto.FirstLanguage,
                    BestLanguage = expectedDto.BestLanguage,
