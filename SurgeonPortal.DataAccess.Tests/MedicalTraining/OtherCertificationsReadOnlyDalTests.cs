...
{
	public class OtherCertificationsReadOnlyDalTests : TestBase<string>
    {
        ...
        public async Task GetByUserIdAsync_ExecutesSprocCorrectly()
        {
            ...
            sqlManager.AddRecords(CreateMany<OtherCertificationsReadOnlyDto>());
        
            var sut = new OtherCertificationsReadOnlyDal(sqlManager);
