...
{
	public class ClinicalActivityReadOnlyDalTests : TestBase<int>
    {
        #region GetAllAsync
        ...
        {
            var expectedSprocName = "[dbo].[get_clinicalactivity]";
        
            var sqlManager = new MockSqlConnectionManager();
            sqlManager.AddRecords(CreateMany<ClinicalActivityReadOnlyDto>());
        
            var sut = new ClinicalActivityReadOnlyDal(sqlManager);
