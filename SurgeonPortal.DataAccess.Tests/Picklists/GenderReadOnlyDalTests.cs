...
{
	public class GenderReadOnlyDalTests : TestBase<int>
    {
        #region GetAllAsync
        ...
        {
            var expectedSprocName = "[dbo].[get_picklist_genders_all]";
            
        
            var sqlManager = new MockSqlConnectionManager();
            sqlManager.AddRecords(CreateMany<GenderReadOnlyDto>());
        
            var sut = new GenderReadOnlyDal(sqlManager);
