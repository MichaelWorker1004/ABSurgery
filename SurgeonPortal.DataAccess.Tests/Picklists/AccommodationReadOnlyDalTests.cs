...
{
	public class AccommodationReadOnlyDalTests : TestBase<int>
    {
        #region GetAllAsync
        ...
        {
            var expectedSprocName = "[dbo].[get_accommodation_picklist]";
            
        
            var sqlManager = new MockSqlConnectionManager();
            sqlManager.AddRecords(CreateMany<AccommodationReadOnlyDto>());
        
            var sut = new AccommodationReadOnlyDal(sqlManager);
