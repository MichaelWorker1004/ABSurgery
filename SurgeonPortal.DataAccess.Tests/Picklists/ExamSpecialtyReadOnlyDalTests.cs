...
{
	public class ExamSpecialtyReadOnlyDalTests : TestBase<string>
    {
        #region GetAllAsync
        ...
        {
            var expectedSprocName = "[dbo].[get_examspecialties]";
        
            var sqlManager = new MockSqlConnectionManager();
            sqlManager.AddRecords(CreateMany<ExamSpecialtyReadOnlyDto>());
        
            var sut = new ExamSpecialtyReadOnlyDal(sqlManager);
