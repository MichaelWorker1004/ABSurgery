...
export interface IDASHBOARD_HIGHLIGHT_CARDS {
  ...
  EXAMREGISTRATION_SUBTITLE: string;
...
export interface IEXAMSCORING_EXAMINATION_SCORE_CARD {
  REMARKS_TITLE: string;
  REMARKS_TITLE_NO_CASE: string;
  SCORE: string;
}
export interface IEXAMSCORING_EXAMINATION_SKIP {
  SUBTITLE: string;
  TITLE: string;
}
export interface IEXAMSCORING_EXAMINATION_START {
  SUBTITLE: string;
  TITLE: string;
}
export interface IEXAMSCORING_EXAMINATION {
  ...
  LIST_DATE: string;
  LIST_TITLE: string;
  SCORE_CARD: IEXAMSCORING_EXAMINATION_SCORE_CARD;
  SKIP: IEXAMSCORING_EXAMINATION_SKIP;
  START: IEXAMSCORING_EXAMINATION_START;
  TIME: string;
  TITLE: string;
}
export interface IEXAMSCORING_EXAMROSTERS {
  CASE_FEEDBACK_SUBTITLE: string;
  CASE_FEEDBACK_TITLE: string;
  TITLE: string;
}
...
export class LanguageLabelsNGX implements ILanguageLabelsNGX {
  ...
  EXAMSCORING = {
    ...
    EXAMINATION: {
      ...
      SCORE_CARD: {
        REMARKS_TITLE: 'EXAMSCORING.EXAMINATION.SCORE_CARD.REMARKS_TITLE',
        REMARKS_TITLE_NO_CASE:
          'EXAMSCORING.EXAMINATION.SCORE_CARD.REMARKS_TITLE_NO_CASE',
        SCORE: 'EXAMSCORING.EXAMINATION.SCORE_CARD.SCORE',
      },
      SKIP: {
        SUBTITLE: 'EXAMSCORING.EXAMINATION.SKIP.SUBTITLE',
        TITLE: 'EXAMSCORING.EXAMINATION.SKIP.TITLE',
      },
      START: {
        SUBTITLE: 'EXAMSCORING.EXAMINATION.START.SUBTITLE',
        TITLE: 'EXAMSCORING.EXAMINATION.START.TITLE',
      },
      TIME: 'EXAMSCORING.EXAMINATION.TIME',
      TITLE: 'EXAMSCORING.EXAMINATION.TITLE',
    },
    EXAMROSTERS: {
      CASE_FEEDBACK_SUBTITLE: 'EXAMSCORING.EXAMROSTERS.CASE_FEEDBACK_SUBTITLE',
      CASE_FEEDBACK_TITLE: 'EXAMSCORING.EXAMROSTERS.CASE_FEEDBACK_TITLE',
