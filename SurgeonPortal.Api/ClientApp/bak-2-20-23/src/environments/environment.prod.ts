...
const env = {
  ...
  apiBaseUrl: '//abrdmdvgis02.vzh.ent.verizon.com/OdnTracker.Api',
  appTitle: 'ODN Tracker',
  bypassLogin: true,
  environmentStatus: 'PROD',
  production: true,
  supportUrl: '',
  vzCommonApiBaseUrl: '//abrdmdvgis02.vzh.ent.verizon.com/Verizon.Common.Api',
