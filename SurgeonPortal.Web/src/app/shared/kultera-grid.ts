...
const KulteraGrid = {
    ...
    setTextHyperlinkCol(headerName: string, fieldName: string, hyperlink: string, replacementVariables: Array<string>, options?: object) {
        let colDef = {
            headerName,
            field: fieldName,
            cellRenderer: (params: ICellRendererParams) => {
                if (params.data[fieldName]) {
                    ...
                    return `<a href="#${link}" target="_blank">` + params.data[fieldName] + '</a>';
                } else {
                    return null;
                }
            }
    ...
    setCustomRenderedCol(headerName: string, fieldName: string, cellRenderer: (params: ICellRendererParams) => string, options?: object) {
        let colDef = {
            headerName,
            field: fieldName,
            cellRenderer
    ...
    setTextEditableCol(headerName: string, fieldName: string, options?: object, cellStyleFnct?: (cell: any) => any) {
        let colDef = {
            headerName,
            field: fieldName,
            editable: true,
    ...
    setNumberEditableCol(headerName: string, fieldName: string, options?: object, cellStyleFnct?: (cell: any) => any) {
        let colDef = {
            headerName,
            field: fieldName,
            editable: true,
    ...
    setDynamicDropListCol(
        ...
        let colDef = {
            ...
            cellEditorParams: (params: { data: { [x: string]: any; }; }) => {
                return {
                    ...
                    cellRenderer: (cRparams: { value: { [x: string]: any; }; }) => {
                        const currentValue = cRparams.value &&
                            typeof cRparams.value === 'string' &&
                            (cRparams.value[itemDisplay] === null || cRparams.value[itemDisplay] === undefined) ? cRparams.value :
                            cRparams.value  && !(cRparams.value[itemDisplay] === null || cRparams.value[itemDisplay] === undefined) ? cRparams.value[itemDisplay]
                            : null;
                        return currentValue;
                    }
                };
            ...
            valueGetter: (params: { data: { [x: string]: any; }; }) => {
                if (params.data && !(params.data[listName] === null || params.data[listName] === undefined) && !(params.data[fieldName] === null || params.data[fieldName] === undefined)) {
                    const item: any = params.data[listName].find((value: { [x: string]: any; }) => value[itemValue] === params.data[fieldName]);
                    if (item && item[itemDisplay]) {
                        return item[itemDisplay];
                    } else {
                        return null;
