...
namespace SurgeonPortal.Library.Picklists
{
    ...
    [Serializable]
	[DataContract]
	public class AppointmentTypeReadOnlyList : YtgReadOnlyListBase<IAppointmentTypeReadOnlyList, IAppointmentTypeReadOnly>, IAppointmentTypeReadOnlyList
    {
        private readonly IAppointmentTypeReadOnlyDal _appointmentTypeReadOnlyDal;

        public AppointmentTypeReadOnlyList(IAppointmentTypeReadOnlyDal appointmentTypeReadOnlyDal)
        {
