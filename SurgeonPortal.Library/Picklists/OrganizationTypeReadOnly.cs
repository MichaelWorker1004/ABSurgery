...
namespace SurgeonPortal.Library.Picklists
{
    ...
    [Serializable]
	[DataContract]
    public class OrganizationTypeReadOnly : YtgReadOnlyBase<OrganizationTypeReadOnly, int>, IOrganizationTypeReadOnly
    {


        public OrganizationTypeReadOnly(IIdentityProvider identityProvider)
