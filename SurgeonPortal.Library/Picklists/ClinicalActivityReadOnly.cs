...
namespace SurgeonPortal.Library.Picklists
{
    ...
    [Serializable]
	[DataContract]
    public class ClinicalActivityReadOnly : YtgReadOnlyBase<ClinicalActivityReadOnly, int>, IClinicalActivityReadOnly
    {


        public ClinicalActivityReadOnly(IIdentityProvider identityProvider)
