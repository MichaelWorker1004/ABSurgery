...
namespace SurgeonPortal.Library.Picklists
{
    ...
    [Serializable]
	[DataContract]
    public class ResidencyProgramReadOnly : YtgReadOnlyBase<ResidencyProgramReadOnly, int>, IResidencyProgramReadOnly
    {


        public ResidencyProgramReadOnly(IIdentityProvider identityProvider)
