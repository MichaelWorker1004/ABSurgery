...
namespace SurgeonPortal.Library.Picklists
{
    ...
    [Serializable]
	[DataContract]
    public class TrainingTypeReadOnly : YtgReadOnlyBase<TrainingTypeReadOnly, int>, ITrainingTypeReadOnly
    {


        public TrainingTypeReadOnly(IIdentityProvider identityProvider)
