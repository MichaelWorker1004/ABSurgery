...
namespace SurgeonPortal.Library.Picklists
{
    ...
    [Serializable]
	[DataContract]
    public class PrimaryPracticeReadOnly : YtgReadOnlyBase<PrimaryPracticeReadOnly, int>, IPrimaryPracticeReadOnly
    {


        public PrimaryPracticeReadOnly(IIdentityProvider identityProvider)
