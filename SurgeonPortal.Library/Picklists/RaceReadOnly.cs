...
namespace SurgeonPortal.Library.Picklists
{
    ...
    [Serializable]
	[DataContract]
    public class RaceReadOnly : YtgReadOnlyBase<RaceReadOnly, int>, IRaceReadOnly
    {


        public RaceReadOnly(IIdentityProvider identityProvider)
        ...
        private void Child_Fetch(RaceReadOnlyDto dto)
        {
            FetchData(dto);
        }

        
		private void FetchData(RaceReadOnlyDto dto)
		{
