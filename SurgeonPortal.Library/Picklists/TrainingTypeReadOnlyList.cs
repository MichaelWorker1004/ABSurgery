...
namespace SurgeonPortal.Library.Picklists
{
    ...
    [Serializable]
	[DataContract]
	public class TrainingTypeReadOnlyList : YtgReadOnlyListBase<ITrainingTypeReadOnlyList, ITrainingTypeReadOnly>, ITrainingTypeReadOnlyList
    {
        private readonly ITrainingTypeReadOnlyDal _trainingTypeReadOnlyDal;

        public TrainingTypeReadOnlyList(ITrainingTypeReadOnlyDal trainingTypeReadOnlyDal)
        {
