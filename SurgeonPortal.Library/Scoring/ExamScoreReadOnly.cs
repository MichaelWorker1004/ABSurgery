...
namespace SurgeonPortal.Library.Scoring
{
    ...
    [Serializable]
	[DataContract]
    public class ExamScoreReadOnly : ReadOnlyBase<ExamScoreReadOnly>, IExamScoreReadOnly
    {
        [DataMember]
        ...
        private void Child_Fetch(ExamScoreReadOnlyDto dto)
        {
            FetchData(dto);
        }

        
		private void FetchData(ExamScoreReadOnlyDto dto)
		{
