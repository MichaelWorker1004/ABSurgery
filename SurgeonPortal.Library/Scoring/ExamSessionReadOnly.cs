...
namespace SurgeonPortal.Library.Scoring
{
    ...
    [Serializable]
	[DataContract]
    public class ExamSessionReadOnly : YtgReadOnlyBase<ExamSessionReadOnly, int>, IExamSessionReadOnly
    {


        public ExamSessionReadOnly(IIdentityProvider identityProvider)
