...
namespace SurgeonPortal.Library.MedicalTraining
{
    ...
    [Serializable]
	[DataContract]
    public class OtherCertificationsReadOnly : YtgReadOnlyBase<OtherCertificationsReadOnly, int>, IOtherCertificationsReadOnly
    {


        public OtherCertificationsReadOnly(IIdentityProvider identityProvider)
