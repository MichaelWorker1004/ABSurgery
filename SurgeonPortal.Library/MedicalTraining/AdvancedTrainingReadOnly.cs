...
namespace SurgeonPortal.Library.MedicalTraining
{
    ...
    [Serializable]
	[DataContract]
    public class AdvancedTrainingReadOnly : YtgReadOnlyBase<AdvancedTrainingReadOnly, int>, IAdvancedTrainingReadOnly
    {


        public AdvancedTrainingReadOnly(IIdentityProvider identityProvider)
